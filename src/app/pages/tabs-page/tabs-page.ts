...
import {
  homeOutline, home, peopleOutline, people, navigateCircleOutline,
  navigateCircle, documentTextOutline, documentText, ellipsisHorizontalOutline,
  globeOutline, personCircleOutline, sparklesOutline, trashOutline, closeOutline } from "ionicons/icons";
...
export class TabsPage {
    ...
    constructor(
        ...
        addIcons({
          homeOutline, home, peopleOutline, people, navigateCircleOutline, navigateCircle, documentTextOutline, documentText, ellipsisHorizontalOutline,
          globeOutline, personCircleOutline, sparklesOutline, trashOutline, closeOutline
         });
    }
